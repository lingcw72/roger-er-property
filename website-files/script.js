const translations = {
  zh: {
    ...
    faqOneQuestion: "Roger 可以协助哪些房产类型？", faqOneAnswer: "组屋、私人公寓、有地住宅及商业地产。",
    faqTwoQuestion: "可以用华语沟通吗？", faqTwoAnswer: "可以。Roger 可用英语和华语为客户提供服务。",
    faqThreeQuestion: "第一次交流时，我应提供哪些资料？", faqThreeAnswer: "只需分享您的房产类型、大致时间规划，以及希望达成的目标，便足以开始交流。",
    faqFourQuestion: "怎样了解目前的市场机会？", faqFourAnswer: "告诉 Roger 您正在寻找什么，他会为您提供最相关的目前选择。",
